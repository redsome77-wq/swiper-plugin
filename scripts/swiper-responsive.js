...
const bestSwiper = new Swiper(best, {
    ...
    //반응형 옵션 breakpoints (사용자의 디자이스 너비 기준)
    //반응형 너비 평균 640 / 768 / 1024 (디자인에 따라 수정, 추가 가능)
    breakpoints:{
        640:{}, //640 이상일때 (숫자는 작은수부터 쓰기)
        768:{
            slidesPerView:3,
        }, //768 이상일때
        1024:{
...
// 탭 제목 클릭시 관련 내용 js
//1. 비활성화 탭 숨기기 //컨버스 숨기기 
season[1].style.display = 'none';
//2. 비활성화 클릭 -> 활성화(active 이동) -> 비활성화 된 탭 숨기기 //컨버스 보이기, 나이키 숨기기
season_title[1].addEventListener('click', function(e){ //e: event
    e.preventDefault();
